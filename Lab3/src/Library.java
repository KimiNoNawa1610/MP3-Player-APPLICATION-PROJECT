...
public class Library{
    ...
    protected final String[] Cname={"ID","Tilte","Genre","Artist","Released Year","Comment"};

    protected final DefaultTableModel newTable = new DefaultTableModel(Cname, 0);

    protected final String user="root";

    protected final String password="";

    protected final String url="jdbc:mysql://localhost:3306/mp3player";

    protected final Connection connection = DriverManager.getConnection(url, user, password);

    protected static ArrayList<String[]> SongURl=new ArrayList<>();
